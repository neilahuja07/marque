    ...
    <DashboardLayout
      ...
      header={
        <div className="mx-auto max-w-7xl px-6 py-4">
          <DashboardSectionHeader title="Orders" count={sellerOrders.length} />
        </div>
      }
    >
            ...
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-ink/10 bg-parchment/50">
                  ...
                  <th className="px-5 py-3 font-medium text-ink/60">Customer</th>
              ...
              <tbody>
                {filtered.map((o) => (
                  <tr key={o.id} className="border-b border-ink/5 last:border-0">
                    ...
                    <td className="px-5 py-3.5 text-slate">Student</td>
